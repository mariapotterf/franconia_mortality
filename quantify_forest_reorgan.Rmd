...
Identify the tree species that are novel (appear after the disturbance) or absent (lost) after disturbances. Compared across triplets between reference (living) and disturbed conditions.

```{r p-winners-loosers, echo = F, fig.height=3.5, fig.width = 3.5, fig.cap= 'Average counts of the winners/loosers per tree species'}
...
```{r p_prevalence, echo = F, fig.cap = 'Average counts per tree species and tree height. Ordered by the most aboundant tree species'}
...
```{r plot-regen-sp-categ, echo = F, fig.height=5, fig.cap = 'Average counts per tree species and tree height category. Ordered by the most aboundant tree species'}
...
Data:
 ...
 - plot level: seedlings, saplings
 
```{r plot-RA4, echo = F, fig.height=3, fig.width=4, fig.cap="Dominant tree species composition for reference and disturbed sites. "}
...
Is the species winning the local competition in the regeneration the same that dominates under reference conditions? Based on height classes.
 ...
 - plot: seedlings, saplings

```{r plot-RA5, echo = F, fig.height=3, fig.width=4, fig.cap="Dominant tree species composition for reference and disturbed sites. "}
...
Data:
 ...
 - plot: seedlings, saplings, mature trees  
...
```{r plot-RS3-all, echo = F, fig.height=3, fig.width=5, fig.cap="Boxplots of the ground cover claaases distribution per each category for reference ('l') and disturbed sites ('d'). "}
